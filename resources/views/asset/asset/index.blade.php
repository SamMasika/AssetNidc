                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Total Assets </p>
            ...
            <div class="col-md-3">
                <div class="card mini-stats-wid">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Number of Computers</p>
                                <h4 class="mb-0">{{$computer->count()}}</h4>
                            </div>
                            <div class="flex-shrink-0 align-self-center">
                                <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                    <span class="avatar-title">
            ...
            <div class="col-md-3">
                <div class="card mini-stats-wid">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Number of Tables</p>
                                <h4 class="mb-0">{{$meza->count()}}</h4>
                            </div>
                            <div class="flex-shrink-0 align-self-center">
                                <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                    <span class="avatar-title">
            ...
            <div class="col-md-3">
                <div class="card mini-stats-wid">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Number of Chairs</p>
                                <h4 class="mb-0">{{$chair->count()}}</h4>
                            </div>
                            <div class="flex-shrink-0 align-self-center">
                                <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                    <span class="avatar-title">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        {{-- @include('asset.asset.unavailable.request') --}}
                        <div class="card-body">
