    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('reject-request/'.$item->id) }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row py-1">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="basicpill-address-input" name="remark" class="form-control" rows="2" placeholder="Enter your Reason........."></textarea>
                            </div>
                        </div>
                    </div>
